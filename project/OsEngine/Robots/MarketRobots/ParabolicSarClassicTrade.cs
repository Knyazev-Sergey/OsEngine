...
public class ParabolicSarClassicTrade : BotPanel
{
    ...
    public ParabolicSarClassicTrade(string name, StartProgram startProgram) : base(name, startProgram)
    {
        ...
        ChangeStepStop = CreateParameter("Stop level change step (pts or %)", 1, 1, 10000, 001m, "Trailing Stop");
        MinDist = CreateParameter("Minimum distance to price (pts or %)", 1, 1, 10000, 0.01m, "Trailing Stop");
