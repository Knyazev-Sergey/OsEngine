...
{
    public class BinanceFuturesServerTLPermission : IServerPermission
    {
        ...
        public string[] IpAddressServer
        {
            get
            {
                ...
                {
                    "fapi.proxy-stage-02.mstrat.fund",
                    "fstream.proxy-stage-02.mstrat.fund",
                    "dapi.proxy-stage-02.mstrat.fund",
                    "dstream.proxy-stage-02.mstrat.fund",
                    "testnet.proxy-stage-02.mstrat.fund",
                    "stream.proxy-stage-02.mstrat.fund"
                };
