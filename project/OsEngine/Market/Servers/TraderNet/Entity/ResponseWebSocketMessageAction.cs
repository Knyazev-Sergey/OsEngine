...
namespace OsEngine.Market.Servers.TraderNet.Entity
{
    ...
    public class ListMD
    {
        public List<ListMdTiker> i; //тикер        
    }
    ...
    public class ResponceFillOrders
    {       
        public List<ResponceFillOrdersTrades> trade; // кол-во
    }

    public class ResponceFillOrdersTrades
    {
        public string date;
        public string id;
        public string p;// цена
        public string q;// кол-во
        public string trade_nb;
        public string type;
    }
